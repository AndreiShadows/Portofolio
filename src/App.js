    ...
    <div className="container bg-white w-90 mx-auto pt-4 rounded-lg shadow-lg pb-5 vertical-center">
      ...
      <div className="row mb-5 d-flex flex-md-row justify-content-around">
        <div className="col-md-3  mx-4 mb-4 value rounded-lg pl-4 pr-3 py-4" style={{background: "#F2F6F9"}}>
          <img src="https://img.icons8.com/ios-filled/50/000000/bios.png" className="mb-3"/>
        ...
        <div className="col-md-3 mx-4 mb-4 value rounded-lg pl-4 pr-3 py-4" style={{background: "#F2F6F9"}}>
          <img src="https://img.icons8.com/ios-filled/50/000000/database-restore.png" className="mb-3"/>
        ...
        <div className=" col-md-3 mx-4 mb-4 value rounded-lg pl-4 pr-3 py-4" style={{background: "#F2F6F9"}}>
          <img src="https://img.icons8.com/fluent-systems-filled/50/000000/thor-hammer.png" className="mb-3"/>
